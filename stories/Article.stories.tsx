...
const example = {
  ...
  answerEditLink:
    'https://docs.google.com/document/d/10g6U9SL0CBy__wCBTib7_WhB3S3aaFt7Fx1vVgCzg2I/edit',
  tags: ['People'],
  banners: [
    {
      title: 'In progress',
...
const normal = {
  ...
  answerEditLink:
    'https://docs.google.com/document/d/1PTf4sitz2hMBWn6qFsB88NrEQEl-ItxkdtZGnvTcSxc/edit',
  tags: ['Objections', 'Plausibility', 'Actors', 'Superintelligence', 'Existential Risk'],
  banners: [],
  relatedQuestions: [
    {
