...
const SvgCommentQuestion = (props) => (
  <svg
  ...
  >
    <path
      d="M256 431.1c-35.1 0-69.4-6.2-101.8-18.4l-8.5-2.3-7.1 5.7c-20.2 16.1-60.1 42-112.7 47.1 14.4-18.3 37.4-51.7 46.6-88.6l2.2-8.8-6.4-6.4C34.1 325.1 16 283.8 16 239.1c0-105.9 107.7-192 240-192s240 86.1 240 192-107.7 192-240 192z"
      style={{
        fill: '#ffffe0',
      }}
    />
