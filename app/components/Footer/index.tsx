    ...
    <div className="padding-top-104">
      ...
      <div className="flexbox padding-bottom-80 padding-top-104">
        ...
        <div className="col-3 small">
          ...
          <Link to="https://www.every.org/stampy?utm_campaign=donate-link#/donate" title="Donate" className="padding-bottom-8" />
          <Link to="https://github.com/StampyAI/stampy-ui" title="Code" className="padding-bottom-8"/>
          <Link to="https://get_involved.aisafety.info/" title="Write" className="padding-bottom-8"/>
        ...
        <div className="partners small col-4">
          ...
          <Link to="https://www.aisafety.com/" title="AISafety.com" className="padding-bottom-8"/>
          <Link to="https://alignment.dev/" title="Alignment Ecosystem Development" className="padding-bottom-8"/>
        </div>
      </div>
