      ...
      <div className="padding-bottom-80">
        <div className="section-grid">
          ...
          <div>
            ...
            <p className="grey default">TODO Intro to AI Safety video playlist</p>
          </div>
        </div>
      </div>
      <div className="padding-bottom-80">
        <div className="section-grid">
          ...
          <div>
            ...
            <p className="grey default">Browse our full list of podcasts (TODO link)</p>
          </div>
        </div>
      </div>
      <div className="padding-bottom-80">
            ...
            <div>
              <div className="padding-bottom-40 padding-top-8">
                ...
                <div className="section-split">
                  <div>
                    <p className="default-bold padding-bottom-16">Lorem ipsum</p>
          ...
          content={
            <div>
              <div className="padding-bottom-40 padding-top-8">
                <p className="large-bold padding-bottom-32">I love books!</p>
                <div className="padding-bottom-40 section-split">
                  <p className="grey default">TODO idk what goes here</p>
                </div>
        ...
        <div className="section-grid">
          ...
          <div>
            ...
            <p className="grey default">
              Browse our{' '}
              <a
                href="https://aisafety.info/questions/8264/What-training-programs-and-courses-are-available-for-AI-safety"
                className="text-teal-500 hover:underline"
              >
                full list of courses (TODO fix link)
              </a>
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <p className="grey default">
                ...
                <a
                  ...
                  className="text-teal-500 hover:underline"
                >
                  full list of events (TODO fix link)
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="section-grid">
            ...
            <p className="grey default-bold">
              ...
              <a
                ...
                className="text-teal-500 hover:underline"
              >
                Full list of fellowships (TODO fix link)
              </a>
            </p>
          </div>
        </div>
