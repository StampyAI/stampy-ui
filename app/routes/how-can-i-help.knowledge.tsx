  ...
  <>
    <div className="padding-bottom-24">
      ...
      >
        ...
        <p className="grey default padding-bottom-24">
          <b>Note:</b> If you take the AISF courses, consider exploring additional views on AI safety
          to help avoid homogeneity in the field, such as <a href="https://www.cold-takes.com/most-important-century/" className="teal-500">The Most Important Century blog post
          series</a>.
